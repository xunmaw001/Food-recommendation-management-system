				...
				<form class="layui-form layui-form-pane" lay-filter="myForm">
						...
						<div class="layui-input-block">
							<input v-model="detail.dianpudizhi" type="text" name="dianpudizhi" id="dianpudizhi" autocomplete="off" class="layui-input">
                                                                                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                                                                                    <div class="layui-form-item" pane>
						<label class="layui-form-label">经典菜品：</label>
						<div class="layui-input-block">
							<textarea name="jingdiancaipin" id="jingdiancaipin">请输入经典菜品</textarea>
						</div>
					</div>
				...
				form.on('submit(*)', function(data) {
                    ...
                    // 数据校验
                        ...
                        return false
                                                                                                                                                                                    					                                                                                                                                                                					...
                                                                                                                                                                                    					                                                                                                                                                                					var jingdiancaipin = tinymce.get('#jingdiancaipin').getContent()
					data.jingdiancaipin = jingdiancaipin;
					...
					// 提交数据
					http.requestJson('meishidianpu' + '/add', 'post', data, function(res) {
					 	layer.msg('提交成功', {
					 		time: 2000,
					 		icon: 6
					 	}, function() {
