		...
		<div id="app">
			...
			<div class="data-add-container">
				...
				<form class="layui-form layui-form-pane" lay-filter="myForm">
						...
						<div class="layui-input-block">
							<input v-model="detail.yongliao" type="text" name="yongliao" id="yongliao" autocomplete="off" class="layui-input">
						</div>
					</div>
                                                                                <div class="layui-form-item" pane>
						<label class="layui-form-label">烹饪方法：</label>
						<div class="layui-input-block">
							<input v-model="detail.pengrenfangfa" type="text" name="pengrenfangfa" id="pengrenfangfa" autocomplete="off" class="layui-input">
						</div>
					</div>
                                                                                <div class="layui-form-item" pane>
						<label class="layui-form-label">烹饪时长：</label>
						<div class="layui-input-block">
							<input v-model="detail.pengrenshizhang" type="text" name="pengrenshizhang" id="pengrenshizhang" autocomplete="off" class="layui-input">
						</div>
					</div>
                                                                                <div class="layui-form-item" pane>
						<label class="layui-form-label">美食特色：</label>
						<div class="layui-input-block">
							<input v-model="detail.meishitese" type="text" name="meishitese" id="meishitese" autocomplete="off" class="layui-input">
						</div>
					</div>
                                                                                                                                            <div class="layui-form-item" pane>
						<label class="layui-form-label">小贴士：</label>
						<div class="layui-input-block">
							<input v-model="detail.xiaotieshi" type="text" name="xiaotieshi" id="xiaotieshi" autocomplete="off" class="layui-input">
						</div>
					</div>
                                                                                <div class="layui-form-item" pane>
						...
						<div class="layui-input-block">
							<input v-model="detail.yonghuming" type="text" name="yonghuming" id="yonghuming" autocomplete="off" class="layui-input">
                                                                                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                                                                                    <div class="layui-form-item" pane>
						<label class="layui-form-label">制作方法：</label>
						<div class="layui-input-block">
							<textarea name="zhizuofangfa" id="zhizuofangfa">请输入制作方法</textarea>
						</div>
					</div>
		...
		<script>
			...
			layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate','tinymce'], function() {
					...
					if (res.data.list.length > 0) {
						...
						carousel.render({
							...
							indicator: "none"
                																...
                																http.request(`option/meishifenlei/fenlei`,'get',{},(res)=>{
					vue.fenlei = res.data
				});
																// 上传图片
				...
				form.on('submit(*)', function(data) {
                    ...
                    // 数据校验
					                    					                                                                                                                                                                					                                                                                                                                                                					                                                                                                                                                                					                                                                                                                                                                					                                                                                                                                                                					                                                            if(!isNumber(data.pengrenshizhang)){
                        layer.msg('烹饪时长应输入数字', {
							time: 2000,
							icon: 5
						});
                        return false
                                                                                                                                            					                                                                                                                                                                					...
                                                                                                                                            					                                                                                                                                                                					var zhizuofangfa = tinymce.get('#zhizuofangfa').getContent()
					data.zhizuofangfa = zhizuofangfa;
