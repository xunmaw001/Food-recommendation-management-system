				...
				<div class="layui-row">
					...
					<div class="layui-col-md7" style="padding-left: 20px;">
						...
						<div v-if="detail.alllimittimes" class="detail-item">
							...
							<span>烹饪方法：</span>
							<span class="desc">
								{{detail.pengrenfangfa}}
							</span>
						</div>
																								<div class="detail-item">
							<span>烹饪时长：</span>
							<span class="desc">
								{{detail.pengrenshizhang}}
							</span>
						</div>
																								<div class="detail-item">
							<span>美食特色：</span>
				...
				<div class="layui-row">
					<div class="layui-tab layui-tab-card">
						...
						<div style="word-break:break-all" class="layui-tab-content">
								...
								<div v-html="detail.zhizuofangfa"></div>
							</div>
			...
			var vue = new Vue({
				...
				methods: {
					...
					onAcrossTap(acrossTable){
						localStorage.setItem('crossTable',`meishijiaocheng`);
