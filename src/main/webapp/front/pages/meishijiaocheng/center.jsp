				...
				<div class="right-container">
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" name="yongliao" id="yongliao" placeholder="用料" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">烹饪方法</label>
							<div class="layui-input-block">
								<input type="text" name="pengrenfangfa" id="pengrenfangfa" placeholder="烹饪方法" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">烹饪时长</label>
							<div class="layui-input-block">
								<input type="text" name="pengrenshizhang" id="pengrenshizhang" placeholder="烹饪时长" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">美食特色</label>
							<div class="layui-input-block">
								<input type="text" name="meishitese" id="meishitese" placeholder="美食特色" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                                                                                        <div class="layui-form-item">
							<label class="layui-form-label">小贴士</label>
							<div class="layui-input-block">
								<input type="text" name="xiaotieshi" id="xiaotieshi" placeholder="小贴士" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
