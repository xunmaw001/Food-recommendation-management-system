		...
		<div id="app">
			...
			<div class="data-add-container">
				...
				<form class="layui-form layui-form-pane" lay-filter="myForm">
						...
						<div class="layui-input-block">
							<input v-model="detail.cailiao" type="text" name="cailiao" id="cailiao" autocomplete="off" class="layui-input">
						</div>
					</div>
                                                                                                                                            <div class="layui-form-item" pane>
						...
						<div class="layui-input-block">
							<textarea name="meishitese" id="meishitese">请输入美食特色</textarea>
						</div>
					</div>
				...
				form.on('submit(*)', function(data) {
                    ...
                    // 数据校验
                        ...
                        return false
                                                                                                                                                                                    					                                                                                                                                                                					...
                                                                                                                                                                                    					                                                                                                                                                                					var meishitese = tinymce.get('#meishitese').getContent()
					data.meishitese = meishitese;
					...
					// 提交数据
					http.requestJson('remenmeishi' + '/add', 'post', data, function(res) {
					 	layer.msg('提交成功', {
					 		time: 2000,
					 		icon: 6
					 	}, function() {
