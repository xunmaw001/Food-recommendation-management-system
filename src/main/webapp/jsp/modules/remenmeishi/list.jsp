...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">热门美食管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>热门美食列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">热门美食列表</h3>							
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th>图片</th>
											<th onclick="sort('cailiao')">材料<i id="cailiaoIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var cailiaoCell  = document.createElement('td');

						 cailiaoCell.innerHTML = item.cailiao;


			row.appendChild(cailiaoCell);
			var meishiteseCell  = document.createElement('td');

						  //如果图文详情包含图片
			  if(item.meishitese && item.meishitese.indexOf('img') != -1){
				//暂时只考虑图片+文字 和 文字+图片的情况
				var beginIndex = item.meishitese.indexOf('<img');
				var endIndex = item.meishitese.indexOf('>');				
				meishiteseCell.innerHTML = item.meishitese.substring(beginIndex, endIndex+1).replace("img","img width='100' height='100'");				
			  }else{
			  	 if(item.meishitese != null && item.meishitese != "" && item.meishitese.length >= 11){
			  		meishiteseCell.innerHTML = item.meishitese.substring(0, 10) + "..."; 
			  	}else{
